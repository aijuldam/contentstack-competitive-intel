...
-- Tables are created before the functions that reference them.
...
-- ─────────────────────────────────────────────────────────────────────────────
-- RLS HELPERS — workspace level (safe to define now; only references above tables)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- RLS HELPER — project level (defined after projects table exists)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- RLS HELPER — asset level (defined after assets table exists)
-- ─────────────────────────────────────────────────────────────────────────────
...
create index generation_runs_project_idx    on generation_runs(project_id);
